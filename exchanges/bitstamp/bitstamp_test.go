...
func TestGetFee(t *testing.T) {
	...
	if resp, err := b.GetFee(exchange.CryptocurrencyTradeFee, "BTCUSD", 1, 1, false, false); resp != float64(0) || err != nil {
		t.Errorf("Test Failed - GetFee() error. Expected: %f, Recieved: %f", float64(0), resp)
	}

	if resp, err := b.GetFee(exchange.CryptocurrencyTradeFee, "BTCUSD", 10000000000, -1000000000, true, true); resp != float64(0) || err != nil {
		t.Errorf("Test Failed - GetFee() error. Expected: %f, Recieved: %f", float64(0), resp)
	}

	if resp, err := b.GetFee(exchange.CryptocurrencyTradeFee, "BTCUSD", 1, 1, true, false); resp != float64(0) || err != nil {
		t.Errorf("Test Failed - GetFee() error. Expected: %f, Recieved: %f", float64(0), resp)
	}

	if resp, err := b.GetFee(exchange.CryptocurrencyTradeFee, "BTCUSD", 10000000000, -1000000000, false, true); resp != float64(0) || err != nil {
		t.Errorf("Test Failed - GetFee() error. Expected: %f, Recieved: %f", float64(0), resp)
	}

	if resp, err := b.GetFee(exchange.CryptocurrencyWithdrawalFee, "BTCUSD", 1, 1, false, false); resp != float64(0) || err != nil {
		t.Errorf("Test Failed - GetFee() error. Expected: %f, Recieved: %f", float64(0), resp)
	}

	if resp, err := b.GetFee(exchange.CyptocurrencyDepositFee, "BTCUSD", 1, 1, false, false); resp != float64(0) || err != nil {
		t.Errorf("Test Failed - GetFee() error. Expected: %f, Recieved: %f", float64(0), resp)
	}

	if resp, err := b.GetFee(exchange.InternationalBankDepositFee, "BTCUSD", 1, 1, false, false); resp != float64(7.5) || err != nil {
		t.Errorf("Test Failed - GetFee() error. Expected: %f, Recieved: %f", float64(7.5), resp)
	}

	if resp, err := b.GetFee(exchange.InternationalBankDepositFee, "BTCUSD", 10000000, 100000, false, false); resp != float64(50) || err != nil {
		t.Errorf("Test Failed - GetFee() error. Expected: %f, Recieved: %f", float64(50), resp)
	}

	if resp, err := b.GetFee(exchange.InternationalBankDepositFee, "BTCUSD", 10000000000, 1000000000, false, false); resp != float64(300) || err != nil {
		t.Errorf("Test Failed - GetFee() error. Expected: %f, Recieved: %f", float64(300), resp)
	}

	if resp, err := b.GetFee(exchange.InternationalBankWithdrawalFee, "BTCUSD", 1, 1, false, false); resp != float64(15) || err != nil {
		t.Errorf("Test Failed - GetFee() error. Expected: %f, Recieved: %f", float64(15), resp)
	}

	if resp, err := b.GetFee(exchange.InternationalBankWithdrawalFee, "BTCUSD", 10000000000, 1000000000, false, false); resp != float64(900000) || err != nil {
